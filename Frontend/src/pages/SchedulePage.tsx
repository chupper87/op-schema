...
export default function SchedulePage() {
    ...
    const [customers] = useState<Customer[]>([
        ...
        { id: 3, name: "Carina Carlsson", personalNumber: "19901010-9999", address: "Parkvägen 12", phone: "070-5555555" },
    ]);

    // Mock measures
    const [measures] = useState<Measure[]>([
        { id: 1, name: "Dusch", defaultDuration: 30, description: "Morgonhjälp + dusch", timeOfDay: "Morgon" },
        { id: 2, name: "Frukost", defaultDuration: 30, description: "Morgonhjälp + frukost", timeOfDay: "Morgon" },
        { id: 3, name: "Lunch", defaultDuration: 45, description: "Hjälp med lunch", timeOfDay: "Mitt på dagen" },
        { id: 4, name: "Middag", defaultDuration: 45, description: "Hjälp med middag", timeOfDay: "Kväll" },
    ]);
