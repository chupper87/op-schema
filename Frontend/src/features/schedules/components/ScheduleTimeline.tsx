...
export default function ScheduleTimeline({
  ...
  return (
    <div className="flex flex-1 flex-col overflow-hidden rounded-xl bg-white shadow-md">
      {/* Shared Scroll Container - Synchronizes horizontal scroll */}
      <div className="flex-1 overflow-auto">
        <div className="flex flex-col" style={{ minWidth: 'max-content' }}>
          ...
          <div className="sticky top-0 z-20 flex border-b border-gray-200 bg-white">
            ...
            <div className="sticky left-0 z-30 w-40 flex-shrink-0 border-r border-gray-200 bg-indigo-50 p-3">
              <h3 className="text-sm font-bold text-indigo-900">Personal</h3>
            </div>

            {/* Time Slots - Synchronized with rows */}
            <div className="flex">
              {timeSlots.map((slot) => (
                <div
          ...
          {/* Employee Rows - Share horizontal scroll with header */}
